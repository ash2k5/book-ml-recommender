...
`books.csv` is a derived subset (~1,500 rows) of the Best Books Ever dataset, selected for
description quality and genre diversity and reformatted for this app.
...
- License: CC BY-NC 4.0 (Attribution-NonCommercial). The dataset and this derived subset may
  be used for noncommercial purposes with attribution.
